module Relationship.Service exposing (Callbacks, Msg(..), callbacks, createTask, deleteTask, findAllTask, findByExampleTask, invokeCreate, invokeDelete, invokeFindAll, invokeFindByExample, invokeRetrieve, invokeUpdate, retrieveTask, routes, update, updateTask)
...
update callbacks action model =
    case Debug.log "relationship.api" action of
        FindAll result ->
            case result of
                Ok relationship ->
